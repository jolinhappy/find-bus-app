...
.find-bus {
  .search-bar {
    ...
    box-shadow: 0px 8px 10px rgba(75, 77, 78, 0.1);
    top: 66px;
    img {
      width: 36px;
      line-height: 44px;
...
.search-keyboard {
  ...
  .keyboard {
    ...
    // grid-template-columns: 1fr 1fr minmax(1fr, 1.5fr) minmax(1fr, 1.5fr) 1fr;
    height: 100%;
    grid-gap: 8px;
    box-sizing: border-box;
    .keyboard__item {
